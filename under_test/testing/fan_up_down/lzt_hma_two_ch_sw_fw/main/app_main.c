...
void app_InitIO(){
    gpio_config_t io_conf = {
        ...
        .pin_bit_mask = (1ULL << RELAY1_ON_IND_LED) | (1ULL << RELAY1_OFF_IND_LED) | ((1ULL << RELAY2_ON_IND_LED) | (1ULL << RELAY2_OFF_IND_LED) |  (1ULL << RELAY_OUT1)),
    ...
    gpio_pad_select_gpio(BUTTON_IN3);
    gpio_set_pull_mode(BUTTON_IN3,GPIO_PULLUP_ONLY);
    gpio_set_direction(BUTTON_IN3, GPIO_MODE_INPUT);
}
